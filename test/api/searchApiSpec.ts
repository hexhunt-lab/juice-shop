...
describe('/rest/products/search', () => {
  ...
  it('GET product search with SQL special characters returns no matches (parameterized query prevents injection)', () => {
  ...
  it('GET product search with UNION SELECT attempt returns no matches (parameterized query prevents injection)', () => {
  ...
  it('GET product search with closing parenthesis injection attempt returns no matches', () => {
    return frisby.get(`${REST_URL}/products/search?q=') union select id,email,password from users--`)
      .expect('status', 200)
      .expect('header', 'content-type', /application\/json/)
      .then(({ json }) => {
  ...
  it('GET product search with UNION SELECT all-columns attempt returns no matches', () => {
  ...
  it('GET product search with UNION SELECT fixed columns returns no matches (injection not possible)', () => {
  ...
  it('GET product search with UNION SELECT user columns returns no matches (injection not possible)', () => {
  ...
  it('GET product search with UNION SELECT sqlite_master returns no matches (injection not possible)', () => {
  ...
  it('GET product search cannot select logically deleted christmas special by comment injection (parameterized query prevents bypass)', () => {
  ...
  it('GET product search cannot select logically deleted unsafe product by comment injection (parameterized query prevents bypass)', () => {
